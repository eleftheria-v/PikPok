...
<html>
	<head>
		<title>Pik - Pok Most Popular </title>
		<meta charset="utf-8" />
	...
	<body>
		...
		<div class="nav">
				  ...
				  <div class="nav-links">
					...
					<a class="active" style="color:slateblue;" href="most_popular.php">Most Popular</a>
               ...
               <form action="search.php" method="post" enctype="multipart/form-data">
                ...
                <button type = 'submit' name='btn'>Search</button>
                      ...
                      <?php
                        ...
                        $result=$conn->query("SELECT * FROM upphoto ORDER BY  likes DESC") or die($conn->error);
